...
P.S. Данный бот создан мужчиной для девушек и работает в тестовом режиме.
Пока...
...
bot_data = {
    'main_menu': {
        'data': construct_keyboard([[(u"\U0001F52E Гороскоп", 'horoscope')],
                                    ...
                                    [(u'\U00002604 NEW (Next Release)', 'new_func')],
    ...
    'motivation': {
        ...
        'message_text': '''Тут тоже пока ничего нет \U0001F625
Зато есть котики, для поднятия настроения''',
        'answer': None
    },
    'new_func': {
        ...
        'message_text': '''Данный функционал пока не доступен и будет дабавлен в слудющих релизах
Следите за обновлениями \U0001F643''',
        'answer': None
    },
    'magic_ball': {
...
token = '5709874426:AAHNUb0mtlb6SSO-BK8FyTZn8nRGe8rPEPs'
