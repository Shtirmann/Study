...
date = 'year'                                                    #значение переменной date

URL = (f"https://www.marieclaire.ru/astro/{sign}/{date}/")      #Исходный URL с которого парсим, с помощью (f"...") подставляем переменные в строку
...
def parser(URL):                                                #Функция парсинга, принимает на вход URL
    ...
    zodiac = soup.find_all("div", class_="block-text")    		#Откуда выгрузка, указание блока "div" и класса "articleParagraph"
